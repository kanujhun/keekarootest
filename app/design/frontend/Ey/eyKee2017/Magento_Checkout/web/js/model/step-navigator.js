        ...
        return {
            ...
            next: function() {
                ...
                if (steps().length > activeIndex + 1) {
                    ...
                    if(code == 'shipping'){
                        $('#sidebar-buttons .button.action.continue.primary > span').html('<span>Continue to <strong>Payment</strong></span>');
                    } else if (code == 'payment') {
                        $('#sidebar-buttons .button.action.continue.primary > span').html('<span>Place Order</span>');
                    }
                }
            }
        };
